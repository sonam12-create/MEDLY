    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit ? <input className='bg-gray-50' type="text" value={userData.address} onChange={e => setUserData(prev => ({ ...prev, address: e.target.value }))} /> : <p className='text-gray-500'>{userData.address.line1}</p>
          }
        </div>
      </div>
      <div>
      ...
      <div className='mt-10'>
        {
          isEdit ?
          <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary cursor-pointer hover:text-white transition-all' onClick={updateUserProfileData}>Save</button>
